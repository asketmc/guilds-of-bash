 ...
 */
@Perf
class CorePerfLoadTest {

    private val stateSeed = 42u
    private val rngSeed = 100L

    private fun steps(): Int = System.getProperty("perf.steps")?.toIntOrNull() ?: 50
    private fun warmup(): Int = System.getProperty("perf.warmup")?.toIntOrNull() ?: 10
